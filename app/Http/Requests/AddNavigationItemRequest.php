...
class AddNavigationItemRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            //
            'nav_code' => 'required|max:' . $this->fieldSizeMaxLimits['nav_code'],
    ...
    {
        return [
            'nav_code.required' => 'The navigation item code should not be empty !',
            'nav_code.max' => 'The navigation item code should not be longer than ' . $this->fieldSizeMaxLimits['nav_code'] . ' characters !',
